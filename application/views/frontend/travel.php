...
<h2 class="main_heading">Now Buying Travel Insurance is Much Simpleir</h2>
    <div class="container health_main">
        <div class="">
            <div class="box_sh ">
                <div class="row">
                    <div class="col-lg-4 col-xs-12 " style="padding:0px;">
                        <img src="<?php echo base_url();?>assest/img/travelinsurance.jpg" >
                        <div class="to">
                            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="date">
                                                <label class="adults" for="dest">Destination</label>
                                                <input type="text"  id="dest" name="desti" placeholder="Enter Destination">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="date">
                                                <label class="adults" for="strip">Trip Start date</label>
                                                <input type="text"  id="my_date_picker" placeholder="DD-MM-YYYY" name="strip" class="lis" readonly required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="date">
                                                <label class="adults" for="etrip">Trip End date</label>
                                                <input type="text"  id="my_date_picker2" placeholder="DD-MM-YYYY" name="etrip" class="lis" readonly required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                <label class="adults" for="trav">No. of Travelers</label>
                                                <input type="number"  id="" name="trav" placeholder="Enter No. of Travelers">
                                            </div>
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                <label class="adults" for="trav">Age of 1st Traveler</label>
                                                <input type="number"  id="" name="trav1" placeholder="Enter Age">
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                <label class="adults" for="trav">Age of 2nd Traveler</label>
                                                <input type="number"  id="" name="trav2" placeholder="Enter Age">
                                            </div>
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="form-group date">
                                                <label class="adults" for="">Do you have Medical Conditions?</label>
                                                <div class="form-check">
                                                    <label class="form-check-label" for="radio1" style="margin-right: 4rem; margin-left: 2rem;">
                                                        <input type="radio" class="form-check-input" id="radio1" name="optradio" value="option1" checked>YES
                                                    </label>
                                                    <label class="form-check-label" for="radio2">
                                                        <input type="radio" class="form-check-input" id="radio2" name="optradio" value="option2" checked>NO
                                                    </label>
                                                </div>
                                            </div>
                                        </div> 
    ...
    <section class="imp">
        <div class="container">
            <h2>Importance of Travel Insurance</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. </p>
        </div>    
    </section>
    <section class="why_Health">
        <div class="container">
            <h2>Why Travel Insurance from Tirupati Insurance ?</h2>
                <div class="row">
